      ...
      <Slider {...settings}>
        <div>
          <div className="mt-48 container mx-auto  text-white flex flex-col items-start gap-y-8">
            <Title addClass="text-5xl">Fast Food Restorant</Title>
            <p className="text-sm sm:w-2/5 w-full">
              Kalite ve hızın buluşma noktası. Her ısırıkta lezzet patlaması.
            </p>
        ...
        <div>
          <div className="mt-48 container mx-auto  text-white flex flex-col items-start gap-y-8">
            <Title addClass="text-5xl">Fast Food Restorant</Title>
            <p className="text-sm sm:w-2/5 w-full">
              Bu eşsiz fast food lezzetini denemeye var mısınız ?
            </p>
            <button className="btn-primary">Hemen Sipariş Ver</button>
          </div>
        </div>
